...
public class Succession extends DoubleEventConstraint implements Eventbased {

    public Succession(Event eventA, Event eventB, ConstraintType type) {
    ...
    public boolean logic(AuxiliaryDatabase ad) {
        ...
        return false;
            ...
            if (!ad.tasksSuccessionResponse.contains(filteredEventB)) {
                ad.tasksSuccessionResponse.add(filteredEventB);
                return true;
            } else
                return false;
